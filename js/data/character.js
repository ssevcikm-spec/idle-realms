(function () {
  ...
  G.BUILDINGS = {
    ...
    workshop:  { id:'workshop', name:'Dílna', icon:'🔧', maxLevel:5, desc:'Vyšší kvalita výroby (+8 skóre za úroveň).',
      cost:(l)=>({ gold:80*l*l, materials:[{material:'wood',qty:5*l},{material:'stone',qty:3*l}] }),
      effect:(l)=>({ craftQualityBonus:8*l, repairDiscount:0.05*l }) },
    tavern:    { id:'tavern', name:'Hospoda', icon:'🍺', maxLevel:5, desc:'Rychlejší regenerace výdrže i nálady (+15 % za úroveň).',
